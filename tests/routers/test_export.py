...
async def test_export_study_all_interviews_json(
    ...
    response = await authenticated_client.get(f"/studies/{study.id}/export?format=json")
...
async def test_export_study_all_interviews_csv(
    ...
    response = await authenticated_client.get(f"/studies/{study.id}/export?format=csv")
...
@pytest.mark.asyncio
async def test_export_invalid_format(authenticated_client: AsyncClient, study_with_interviews):
...
@pytest.mark.asyncio
async def test_export_interview_not_found(authenticated_client: AsyncClient, study_with_interviews):
...
@pytest.mark.asyncio
async def test_export_unauthorized_user(client: AsyncClient, study_with_interviews):
    ...
    response = await client.get(f"/studies/{study.id}/interviews/{interview.id}/export?format=json")
...
@pytest.mark.asyncio
async def test_export_filename_sanitization(authenticated_client: AsyncClient, test_user, test_db):
