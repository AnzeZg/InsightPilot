...
def study_with_varied_interviews(test_db, test_user):
    ...
    try:
        ...
        interview_crud.create_message(
            ...
            interview_id=interview1.id,
            role="user",
            content="This product is amazing and intuitive!",
        )
        interview_crud.create_message(
        ...
        interview_crud.create_message(
            ...
            interview_id=interview3.id,
            role="user",
            content="I'm frustrated with the interface.",
        )
        interview_crud.create_message(
...
@pytest.mark.asyncio
async def test_get_analytics_empty_study(authenticated_client: AsyncClient, test_user, test_db):
...
@pytest.mark.asyncio
async def test_get_analytics_unauthorized(client: AsyncClient, study_with_varied_interviews):
...
@pytest.mark.asyncio
async def test_get_analytics_no_auth(client: AsyncClient, study_with_varied_interviews):
...
@pytest.mark.asyncio
async def test_get_analytics_not_found(authenticated_client: AsyncClient):
